<?php	
	...
	if (empty($_POST['name'])) {
           $errors[] = "Nombre vacío";
			...
			$errors[] = "Seleccione el Area de trabajo";
		}else if (empty($_POST['nivel'])){
			$errors[] = "Seleccione el nivel";
		...
		if(isset($_POST["is_admin"])){$is_admin=1;}
			...
			$sql="INSERT INTO user ( name, username, password, nivel,area, profile_pic, is_active, created_at) VALUES ('$end_name','$username','$password','$nivel','$area','$profile_pic',$status,'$created_at')";
